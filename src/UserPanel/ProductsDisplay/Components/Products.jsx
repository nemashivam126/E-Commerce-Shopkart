...
import { Card, CardContent, CardMedia, Grid, Typography, Box, Drawer, List, ListItem, Checkbox, FormControlLabel, CircularProgress } from '@mui/material';
        ...
        <Grid container spacing={3}>
          {
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: '70vh', width: '100%' }}>
              <SearchOff color="error" sx={{ fontSize: 100, mb: 2 }} />
